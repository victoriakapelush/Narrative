  ...
  return (
    <div className="flex-row-spacebtw header">
      ...
      <div className="flex-row-center">
        ...
        <Link to="/lifestyle" className="header-link">
          Lifestyle
        </Link>
        <Link to="/technology" className="header-link">
          Technology
        </Link>
      ...
      <div className="flex-row-center">
        <Link to="/addpost" className="header-button">
          Create Post
        </Link>
        ...
        <form method="post" onClick={handleSubmit}>
          <button type="submit" className="header-button logout-btn">
            Log out
          </button>
        </form>
      </div>
